...
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_init(JNIEnv*, jobject, jint width, jint height) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_resize(JNIEnv*, jobject, jint width, jint height) {
    gWidth = static_cast<float>(std::max(1, width));
    gHeight = static_cast<float>(std::max(1, height));
    glViewport(0, 0, width, height);
}
...
extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_render(JNIEnv*, jobject, jfloat delta) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_setMove(JNIEnv*, jobject, jfloat x, jfloat y) {
    gMoveX = std::clamp(static_cast<float>(x), -1.0f, 1.0f);
    gMoveY = std::clamp(static_cast<float>(y), -1.0f, 1.0f);
}

extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_setSprintHeld(JNIEnv*, jobject, jboolean held) {
    gSprintHeld = held == JNI_TRUE;
}

extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_orbitCamera(JNIEnv*, jobject, jfloat deltaYaw, jfloat deltaPitch) {
    gController.camera.orbit(static_cast<float>(deltaYaw), static_cast<float>(deltaPitch));
}

extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_toggleViewMode(JNIEnv*, jobject) {
    gViewMode = gViewMode == ViewMode::ThirdPerson ? ViewMode::FirstPerson : ViewMode::ThirdPerson;
    gWorldMapVisible = false;
}

extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_setPlayerCharacterTexture(JNIEnv* env, jobject, jint width, jint height, jintArray pixels) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_setWorldMapVisible(JNIEnv*, jobject, jboolean visible) {
    gWorldMapVisible = visible == JNI_TRUE;
}

extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_setAuthoritativeOnline(JNIEnv*, jobject, jboolean enabled) {
    gAuthoritativeOnline = enabled == JNI_TRUE;
}

extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_setAuthoritativeBossHealth(JNIEnv*, jobject, jint health) {
    gEnemyHealth = std::clamp(static_cast<float>(health), 0.0f, kForestWardenMaxHealth);
}

extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_applyAuthoritativeInventory(JNIEnv*, jobject, jint wood, jint fiber, jint stone, jboolean emberKit) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_applyAuthoritativeCompanion(JNIEnv*, jobject, jint creatureIndex, jboolean stay, jint revision) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_applyAuthoritativeCamp(JNIEnv*, jobject, jboolean built, jfloat x, jfloat y, jfloat z, jfloat yaw, jfloat scale, jint revision) {
    const int committedRevision = static_cast<int>(revision);
    if (built != JNI_TRUE) {
        gCampBuilt = false;
...
extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_setWorldTime(JNIEnv*, jobject, jfloat worldTime) {
    if (std::isfinite(static_cast<float>(worldTime))) gSynchronizedWorldTime = std::max(0.0f, static_cast<float>(worldTime));
}

extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_setCoOpPeer(JNIEnv*, jobject, jint index, jboolean active, jfloat x, jfloat y, jboolean atTower) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_clearCoOpPeers(JNIEnv*, jobject) {
    for (CoOpPeer& peer : gCoOpPeers) peer = {};
}

extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_teleportToTower(JNIEnv*, jobject) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_syncTeleportToTower(JNIEnv*, jobject, jint revision) {
    gController.body.position = {-0.06f, 0.28f};
    gController.body.velocity = {0.0f, 0.0f};
    gController.body.verticalPosition = 0.0f;
    gController.body.verticalVelocity = 0.0f;
...
extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_setGyroEnabled(JNIEnv*, jobject, jboolean enabled) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_setGyro(JNIEnv*, jobject, jfloat rotationX, jfloat rotationY, jfloat sensitivity) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_setGraphicsQuality(JNIEnv*, jobject, jint level) {
    gGraphicsQuality = std::clamp(static_cast<int>(level), 0, 4);
}

extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_setContentTierReady(JNIEnv*, jobject, jboolean ready, jint tier) {
    gContentTierReady = ready == JNI_TRUE;
    gGraphicsQuality = std::clamp(static_cast<int>(tier), 0, 4);
}

extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_attack(JNIEnv*, jobject) {
    if (gCombat.requestAttack()) gController.state = forest::controller::LocomotionState::Attack;
}

extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_heavyAttack(JNIEnv*, jobject) {
    if (gCombat.requestHeavyAttack()) gController.state = forest::controller::LocomotionState::Attack;
}

extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_jump(JNIEnv*, jobject) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_dodge(JNIEnv*, jobject) {
    if (gCombat.requestDodge() && gController.dodge()) gDodgePulse = 8;
}

extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_slide(JNIEnv*, jobject) {
    if (gCombat.requestDodge() && gController.slide()) gDodgePulse = 6;
}

extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_gather(JNIEnv*, jobject) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_craft(JNIEnv*, jobject) {
    if (gWood >= 3 && gFiber >= 2) {
        gWood -= 3;
        gFiber -= 2;
        ++gCraftPulse;
...
extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_captureNearestCreature(JNIEnv*, jobject) {
    const int target = nearestLivingMob();
    if (target < 0) return;
...
extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_toggleCompanionCommand(JNIEnv*, jobject) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_buildCamp(JNIEnv*, jobject) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_interactEmberling(JNIEnv*, jobject) {
    const forest::rpg::EmberlingInteraction outcome = forest::rpg::interactWithEmberling(
        gEmberling, gProgression.emberKitCrafted, gFiber, gPlayerX, gPlayerY);
...
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_getHudState(JNIEnv* env, jobject) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_getCoOpLocalState(JNIEnv* env, jobject) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_getCloudState(JNIEnv* env, jobject) {
...
Java_com_darkvirgoyt_aethelgrand_NativeGameBridge_loadCloudState(JNIEnv* env, jobject, jstring payload) {
