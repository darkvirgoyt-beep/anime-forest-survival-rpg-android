...
inline std::string serializeCloudState(const CloudState& state) {
    ...
    std::snprintf(buffer, sizeof(buffer),
        "{\"schemaVersion\":3,\"playerX\":%.6f,\"playerY\":%.6f,\"health\":%.6f,\"stamina\":%.6f,\"hunger\":%.6f,\"wood\":%d,\"fiber\":%d,\"stone\":%d,\"experience\":%d,\"level\":%d,\"experienceToNext\":%d,\"totalExperience\":%d,\"day\":%d,\"worldTime\":%.6f,\"gatheringActions\":%d,\"questStage\":%d,\"emberKitCrafted\":%d,\"wardenDefeated\":%d}",
