...
class AethelgardWorldMapView(context: Context) : View(context) {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        val forestRight = mapX(rect, 34f)
        val sandRight = mapX(rect, 68f)
        paint.color = Color.rgb(29, 91, 67)
        canvas.drawRect(rect.left - 40f, rect.top - 40f, forestRight, rect.bottom + 40f, paint)
        paint.color = Color.rgb(111, 76, 43)
        canvas.drawRect(forestRight, rect.top - 40f, sandRight, rect.bottom + 40f, paint)
        paint.color = Color.rgb(50, 84, 123)
        canvas.drawRect(sandRight, rect.top - 40f, rect.right + 40f, rect.bottom + 40f, paint)
