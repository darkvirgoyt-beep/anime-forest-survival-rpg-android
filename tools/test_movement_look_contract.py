...
def main() -> None:
    ...
    require("cameraRelative" in controller and "-input.moveX * cosYaw" in controller and "input.moveY * cosYaw" in controller, "movement must use the GLES renderer-aligned camera basis")
    require("-input.moveX * cosYaw - input.moveY * sinYaw" in controller and "input.moveX * sinYaw - input.moveY * cosYaw" in controller, "corrected renderer-aligned camera basis must be present")
