...
REQUIRED = (
    ...
    ("app/src/main/java/com/darkvirgoyt/aethelgrand/MainActivity.kt", "ENTER CORE ONLINE WORLD", "safe core-world entry when optional high graphics are unavailable"),
    ("app/src/main/java/com/darkvirgoyt/aethelgrand/MainActivity.kt", "markCoreOnlineContentReady", "core-world content readiness boundary"),
    ("app/src/main/java/com/darkvirgoyt/aethelgrand/MainActivity.kt", "override fun onBackPressed", "Android back navigation guard"),
    ("app/src/main/java/com/darkvirgoyt/aethelgrand/MainActivity.kt", "Do you want to close this game?", "close confirmation copy"),
    ("app/src/main/java/com/darkvirgoyt/aethelgrand/MainActivity.kt", "‹  BACK", "visible back arrow action"),
    ("app/src/main/java/com/darkvirgoyt/aethelgrand/MainActivity.kt", "finishAndRemoveTask()", "confirmed game close"),
    ("app/src/main/java/com/darkvirgoyt/aethelgrand/MainActivity.kt", "isVerticalScrollBarEnabled = true", "scrollable character setup"),
    ("app/src/main/java/com/darkvirgoyt/aethelgrand/PrivateContentDownloader.kt", "archiveSha256", "private archive verification"),
    ("app/src/main/java/com/darkvirgoyt/aethelgrand/PrivateContentDownloader.kt", "Private high-end content manifest HTTP", "specific private-content delivery diagnostics"),
    ...
    ("app/src/main/res/values/strings.xml", "https://aethelgard-api-v2.onrender.com/v1", "live Render v2 game-auth endpoint"),
