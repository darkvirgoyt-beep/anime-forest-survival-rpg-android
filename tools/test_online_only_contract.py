...
REQUIRED = (
    ...
    ("app/src/main/AndroidManifest.xml", 'android:appCategory="game"', "Android game-category metadata"),
    ("app/src/main/java/com/darkvirgoyt/aethelgrad/MainActivity.kt", "applyPerformanceProfile", "device-aware Aethelgard performance profiles"),
