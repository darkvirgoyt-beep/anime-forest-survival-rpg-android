...
FORBIDDEN = (
    ...
    ("app/src/main/java/com/darvirgoyt/aethelgrad/MainActivity.kt", "canUseBundledFreeFallback", "bundled graphics bypass"),
    ("app/src/main/java/com/darvirgoyt/aethelgrad/MainActivity.kt", "requestGuestSignIn", "automatic guest login"),
    ("app/src/main/java/com/darvirgoyt/aethelgrad/MainActivity.kt", "GUEST SESSION", "guest login UI"),
    ("app/src/main/java/com/darvirgoyt/aethelgrad/MainActivity.kt", "OPTIONAL GOOGLE LINK", "optional login copy"),
    ("app/src/main/java/com/darvirgoyt/aethelgrad/MainActivity.kt", "FREE LOCAL GRAPHICS MODE READY", "bundled graphics mode"),
    ("app/src/main/java/com/darvirgoyt/aethelgrad/MainActivity.kt", "activateOfflinePrototype", "offline prototype entry"),
    ("app/src/main/java/com/darvirgoyt/aethelgrad/AssetPackCatalog.kt", "canUseBundledFreeFallback", "bundled graphics bypass"),
    ("app/src/main/java/com/darvirgoyt/aethelgrad/AccountSessionManager.kt", "requestGuestSignIn", "guest auth implementation"),
