...
CHECKS = (
    ...
    ("app/src/main/java/com/darvirgoyt/aethelgrad/AssetPackCatalog.kt", "isPlayAssetDeliveryInstall", "direct APK delivery detection"),
    ("app/src/main/java/com/darvirgoyt/aethelgrad/MainActivity.kt", "PLAY OFFLINE PROTOTYPE", "direct APK offline fallback"),
